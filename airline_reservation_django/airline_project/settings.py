...
SECRET_KEY = 'django-insecure-%cd4_xzak@00mbe6=7w!nhjq^yu1xt4w)_wzqwen@0ux(=d#e2'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('POSTGRES_DB', 'airline_db'),
        'USER': os.getenv('POSTGRES_USER', 'bususer'),
        'PASSWORD': os.getenv('POSTGRES_PASSWORD', 'bus'),
